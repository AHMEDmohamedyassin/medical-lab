...
const WhyUsAboutPageComp = () => {
  return (
        ...
        >
          ...
          <div className='w-full xl:w-[1170px] flex flex-col justify-start items-center gap-y-4 mx-auto'>
            ...
            <div className='flex justify-between flex-wrap xl:flex-nowrap items-start w-full'>
              ...
              <div className=' h-32 w-[1px] bg-gray-300 hidden xl:inline'></div>
