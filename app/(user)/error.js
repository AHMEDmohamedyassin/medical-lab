...
const page = ({error , reset}) => {
  return (
    <div className='max-w-[1026px] mx-auto flex flex-col items-center'>
        ...
        <div className='flex flex-col items-center'>
            ...
            <button onClick={() => reset()} className='bg-transparet border-[1px] border-[#222] text-black py-[10px] px-10 font-semibold text-sm w-full md:w-fit hover:bg-gray-500 hover:text-white hover:border-transparent mt-4 '>إعادة المحاولة</button>
